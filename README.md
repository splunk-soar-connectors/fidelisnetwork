...
This table lists the configuration variables required to operate Fidelis Network. These variables are specified when configuring a Fidelis Network asset in Splunk SOAR.
